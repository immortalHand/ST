			...
			<div class="m_right">
				...
				<table class="tb">
				 ...
				 <div class="pages">
                    ...
                    <a href='${pageContext.request.contextPath }/user/userall.do?pageIndex=${pageIndex-1}'
                    		 class="p_pre" >上一页</a>
                   	</c:if>
                    <c:forEach begin="1" end="${pageCount }" step="1" varStatus="status">
                    	<a href="${pageContext.request.contextPath }/user/userall.do?pageIndex=${status.count}">${status.count }</a>
                    </c:forEach>
